...
class ExtendParameter():    
    casename, runname, Zeros = 'RBC300', 'run1', 7
    cams, t, dt = [0,1,2,3], 15010, 1   
...
def main(): 
    ...
    axis[0].set_xlim(params.Vmin[0],params.Vmax[0]),axis[0].set_ylim(params.Vmin[1],params.Vmax[1]),axis[0].set_zlim(params.Vmin[2],params.Vmax[2])
    axis[1].set_xlim(params.Vmin[0],params.Vmax[0]),axis[1].set_ylim(params.Vmin[1],params.Vmax[1]),axis[1].set_zlim(params.Vmin[2],params.Vmax[2])
    ...
    # debug tracks with ground truth
